...
DNP3 = {
    ...
    "frames": [
        ...
        {"n":31,"t":"13.524","src":"10.20.0.66","dst":"10.20.0.20","layer":"DNP3","summary":"⚠ Cold Restart (rogue host)","anomaly":True,
         ...
         "teach":"A restart is a denial-of-availability weapon in OT: while the RTU reboots, operators are blind and cannot control the site. No credentials were needed.",
    ...
    "extras": [
        ...
        {"title":"When you encrypt, you blind your network sensor",
